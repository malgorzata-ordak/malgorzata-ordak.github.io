...
.then (resp => {
   ...
   for (let repo of resp) {
       ...
       <div class="project__box">
         <img src="img/Github-Icon.svg" class="project__box-icon" alt="" />
         ...
         <p class="project__grid">
           ...
           <span>&lt;<a class="project__span-four" 
             href="${homepage}" title="${name} - demo">see here</a>&gt;
           </span>
         </p>
         <p class="project__grid">
           <span class="project__span-one">github:</span>
           <span>&lt;<a class="project__span-four"
               href="${html_url}" title="${name} - code">source code</a>&gt;
           </span>
         </p>
       </div>
     </article>`;
